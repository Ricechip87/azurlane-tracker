...
const expectedCharacters = [
  ...
  },
  {
    ...
    shipType: '경순',
    faction: 'META',
    techPoints: { acquired: 10, maxLB: 21, lv120: 16 },
    statAcquired: { shipTypes: ['경순'], stat: '내구', value: 1 },
    stat120: { shipTypes: ['경순'], stat: '대공', value: 1 },
    iconFile: '9702130.png',
  },
  {
    id: 746,
    name: '슈퍼브',
    ...
    statAcquired: { shipTypes: ['경순'], stat: '대공', value: 1 },
    stat120: { shipTypes: ['경순'], stat: '명중', value: 1 },
    iconFile: '202370.png',
  },
  {
    id: 747,
    ...
    shipType: '중순',
    faction: '로열',
    techPoints: { acquired: 14, maxLB: 28, lv120: 21 },
    statAcquired: { shipTypes: ['중순', '모니터', '초순'], stat: '내구', value: 1 },
    stat120: { shipTypes: ['중순', '모니터', '초순'], stat: '장전', value: 1 },
    iconFile: '203140.png',
  },
  {
    id: 748,
    ...
    shipType: '구축',
    faction: '로열',
    techPoints: { acquired: 5, maxLB: 11, lv120: 8 },
    statAcquired: { shipTypes: ['구축'], stat: '내구', value: 1 },
