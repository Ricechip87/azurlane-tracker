...
function HomePage() {
  return (
    <main className="mx-auto max-w-[1500px] p-6">
      <section className="relative min-h-[420px] overflow-hidden rounded border border-gray-800 bg-gray-900 md:aspect-[2048/1220] md:min-h-0">
        <img
          src={heroImage}
          alt=""
        ...
        <div className="relative flex min-h-[420px] max-w-3xl flex-col justify-center px-8 py-10 md:min-h-full">
