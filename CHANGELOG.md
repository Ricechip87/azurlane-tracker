...
- Keep status, progression, and obtainable points in their dedicated columns; show only the Operation Siren rank below each candidate name as the non-duplicated external recommendation signal.
